...
float GranulatorMonoGUI::get_inputGain()		{ return m_dialInputGain->get_value(); }
float GranulatorMonoGUI::get_grainSize()		{ return m_dialGrainSize->get_value(); }
float GranulatorMonoGUI::get_attack()			{ return m_dialAttack->get_value(); }
float GranulatorMonoGUI::get_release()			{ return m_dialRelease->get_value(); }
float GranulatorMonoGUI::get_grainDensity()		{ return m_dialGrainDensity->get_value(); }
float GranulatorMonoGUI::get_grainSpread()		{ return m_dialGrainSpread->get_value(); }
float GranulatorMonoGUI::get_outputGain()		{ return m_dialOutputGain->get_value(); }
...
static int _ = GranulatorMonoGUI::register_class("http://avwlv2.sourceforge.net/plugins/avw/granulator_mono/gui");
