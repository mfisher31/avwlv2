...
CVSGUI::CVSGUI(const std::string& URI)
{
	...
	m_dialCV1 = new LabeledDial("CV", p_slotCV1, p_cv1, 0, 5, false, 0.01, 2);
	...
	m_dialCVFine1 = new LabeledDial("Fine", p_slotCVFine1, p_cvFine1, -0.5, 0.5, false, 0.001, 3);
	...
	m_dialCV2 = new LabeledDial("CV", p_slotCV2, p_cv2, 0, 5, false, 0.01, 2);
	...
	m_dialCVFine2 = new LabeledDial("Fine", p_slotCVFine2, p_cvFine2, -0.5, 0.5, false, 0.001, 3);
	...
	m_dialCV3 = new LabeledDial("CV", p_slotCV3, p_cv3, 0, 5, false, 0.01, 2);
	...
	m_dialCVFine3 = new LabeledDial("Fine", p_slotCVFine3, p_cvFine3, -0.5, 0.5, false, 0.001, 3);
	...
	m_dialCV4 = new LabeledDial("CV", p_slotCV4, p_cv4, 0, 5, false, 0.01, 2);
	...
	m_dialCVFine4 = new LabeledDial("Fine", p_slotCVFine4, p_cvFine4, -0.5, 0.5, false, 0.001, 3);
...
static int _ = CVSGUI::register_class("http://avwlv2.sourceforge.net/plugins/avw/cvs/gui");
