...
float VCAExpGUI::get_gain1()		{ return m_dialGain1->get_value(); }
float VCAExpGUI::get_gain2()		{ return m_dialGain2->get_value(); }
float VCAExpGUI::get_in1()			{ return m_dialIn1->get_value(); }
float VCAExpGUI::get_in2()			{ return m_dialIn2->get_value(); }
float VCAExpGUI::get_outputLevel()	{ return m_dialOutputLevel->get_value(); }
...
static int _ = VCAExpGUI::register_class("http://avwlv2.sourceforge.net/plugins/avw/vcaexp/gui");
