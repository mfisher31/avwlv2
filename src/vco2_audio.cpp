...
Vco2Audio::Vco2Audio(double rate) :
Plugin<Vco2Audio> (p_n_ports)
{
...
void Vco2Audio::run(uint32_t nframes)
{
	unsigned int l2;
	unsigned phint;
...
static int _ = Vco2Audio::register_class("http://avwlv2.sourceforge.net/plugins/avw/vco2_audio");
