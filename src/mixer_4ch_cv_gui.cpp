...
float Mixer4ChCVGUI::get_gain(){ return m_dialGain->get_value(); }
float Mixer4ChCVGUI::get_volume1(){ return m_dialVolume1->get_value(); }
float Mixer4ChCVGUI::get_volume2(){ return m_dialVolume2->get_value(); }
float Mixer4ChCVGUI::get_volume3(){ return m_dialVolume3->get_value(); }
float Mixer4ChCVGUI::get_volume4(){ return m_dialVolume4->get_value(); }
...
static int _ = Mixer4ChCVGUI::register_class("http://avwlv2.sourceforge.net/plugins/avw/mixer_4ch_cv/gui");
