...
float Noise2CVGUI::get_randomRate() { return m_dialRandomRate->get_value(); }
float Noise2CVGUI::get_randomLevel() { return m_dialRandomLevel->get_value(); }
...
static int _ = Noise2CVGUI::register_class("http://avwlv2.sourceforge.net/plugins/avw/noise2_cv/gui");
